...
export const SKIN_DESIGN_SIZE: Record<ConsoleType, DesignSize> = {
  ...
  // Carte "coque de telephone" portrait native (voir SegaGameGearSkin et
  // AtariLynxSkin) : le mode paysage n'est pas une disposition
  // differente, juste cette meme carte tournee de 90deg - voir
  // SKIN_DESIGN_SIZE_LANDSCAPE.
  [ConsoleType.AtariLynx]: { width: 300, height: 520 },
  [ConsoleType.SegaGameGear]: { width: 300, height: 520 },
  [ConsoleType.PcEngineGt]: { width: 300, height: 520 },
  [ConsoleType.NeoGeoPocket]: { width: 300, height: 520 },
 ...
 * carte (voir `.gg-skin__case--rotated` / `.lynx-skin__case--rotated`)
 * plutot qu'une disposition distincte : l'empreinte occupee a l'ecran
 * devient alors largeur/hauteur inversees, c'est cette valeur qu'il faut
 * utiliser pour le calcul d'echelle plein ecran (DeviceShell) quand le
 * telephone est en paysage.
 */
export const SKIN_DESIGN_SIZE_LANDSCAPE: Partial<Record<ConsoleType, DesignSize>> = {
  ...
  [ConsoleType.AtariLynx]: { width: 520, height: 300 },
  [ConsoleType.NeoGeoPocket]: { width: 520, height: 300 },
  [ConsoleType.PcEngineGt]: { width: 520, height: 300 },
};
